...
public class MontarChaveCompostaQuestaoUseCase {
    private final QuestaoGateway questaoGateway;
    private final AvaliacaoGateway avaliacaoGateway;

    public MontarChaveCompostaQuestaoUseCase(QuestaoGateway questaoGateway, AvaliacaoGateway avaliacaoGateway) {
        this.questaoGateway = questaoGateway;
        this.avaliacaoGateway = avaliacaoGateway;
    }

    public QuestaoCompoundKey execute(Integer fkAvaliacao, Integer idQuestao){
        if (fkAvaliacao == null || idQuestao == null || fkAvaliacao <= 0 || idQuestao <= 0){
        ...
        idComposto.setIdQuestao(idQuestao);
