...
public class CriarNovaChaveCompostaMatriculaUseCase {
    private final CursoGateway cursoGateway;
    private final UsuarioGateway usuarioGateway;

    public CriarNovaChaveCompostaMatriculaUseCase(CursoGateway cursoGateway, UsuarioGateway usuarioGateway) {
